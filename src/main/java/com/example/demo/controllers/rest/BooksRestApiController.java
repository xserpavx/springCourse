...
public class BooksRestApiController {
    ...
    public ResponseEntity<List<Book>> getBooksByTag(@PathVariable String id, @RequestParam("offset") Integer offset, @RequestParam("limit") Integer limit) {
    ...
    public ResponseEntity<List<Book>> getPopularBooks(@RequestParam("offset") Integer offset, @RequestParam("limit") Integer limit) {
    ...
    public ResponseEntity<List<Book>> getRecentBooks(@RequestParam("offset") Integer offset, @RequestParam("limit") Integer limit) {
    ...
    public ResponseEntity<List<Book>> getRecentBooksByDate(@RequestParam(value = "from") String from, @RequestParam(value = "to") String to, @RequestParam("offset") Integer offset, @RequestParam("limit") Integer limit) {
    ...
    public ResponseEntity<List<Book>> getBooksByAuthor(@PathVariable String slug, @RequestParam("offset") Integer offset, @RequestParam("limit") Integer limit) {
