...
public class BookReview {
    @Id
    @SequenceGenerator( name = "bookReviewSequence", sequenceName = "BOOK_REVIEW_SEQ", allocationSize = 1, initialValue = 5000)
    @GeneratedValue( strategy = GenerationType.SEQUENCE, generator = "bookReviewSequence")
