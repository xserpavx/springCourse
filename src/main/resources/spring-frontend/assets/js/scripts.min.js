                                    ...
                                    $.ajax({
                                        ...
                                        complete: function(result) {
                                            if (result.status === 200) {
                                                ...
                                                $Middle.find('.Middle-searchHeader').text('Найдено ' + result.responseJSON.count + ' книг' + (result.responseJSON.count % 10 < 10 && result.responseJSON.count % 10 > 20 ? (result.responseJSON.count % 10 === 1 ? 'a' : (result.responseJSON.count % 10 > 1 && result.responseJSON.count % 10 < 5 ? 'и' : '')) : ''))
