...
insert into books (title, priceOld, price, id_author) values ('Этюд в багровых тонах', '₽203.23', '₽43.37', 1);
insert into books (title, priceOld, price, id_author) values ('Собака Баскервилей', '₽203.23', '₽43.37', 1);
insert into books (title, priceOld, price, id_author) values ('Короли и капуста', '₽203.23', '₽43.37', 2);
insert into books (title, priceOld, price, id_author) values ('Благородный Жулик', '₽203.23', '₽43.37', 2);
insert into books (title, priceOld, price, id_author) values ('Горящий светильник', '₽203.23', '₽43.37', 2);
insert into books (title, priceOld, price, id_author) values ('Дороги судьбы', '₽203.23', '₽43.37', 2);
insert into books (title, priceOld, price, id_author) values ('Деловые люди', '₽203.23', '₽43.37', 2);
insert into books (title, priceOld, price, id_author) values ('Дети капитана Гранта', '₽203.23', '₽43.37', 3);
insert into books (title, priceOld, price, id_author) values ('20 тысяч лье под водой', '₽203.23', '₽43.37', 3);
insert into books (title, priceOld, price, id_author) values ('Таинственный остров', '₽203.23', '₽43.37', 3);
insert into books (title, priceOld, price, id_author) values ('Хоббит или туда и обратно', '₽203.23', '₽43.37', 4);
insert into books (title, priceOld, price, id_author) values ('Братство кольца', '₽203.23', '₽43.37', 4);
insert into books (title, priceOld, price, id_author) values ('Две твердыни', '₽203.23', '₽43.37', 4);
insert into books (title, priceOld, price, id_author) values ('Возвращение короля', '₽203.23', '₽43.37', 4);
insert into books (title, priceOld, price, id_author) values ('А.Милн. Винни Пух и Все-Все-Все', '₽203.23', '₽43.37', 5);
insert into books (title, priceOld, price, id_author) values ('Л.Кэррол. Алиса в стране чудес', '₽203.23', '₽43.37', 5);
